...
const questions = [
  {
    questions: "Tulang merupakan jaringan elastis yang hidup, yang dipecah dan dibangun untuk menyusun rangka manusia selama kehidupan. Fungsi rangka tubuh sebagai berikut, kecuali..",
  ...
  {
    questions: "Rangka manusia dikelompokkan menjadi dua macam yaitu...",
  ...
  {
    questions: "Pilihan dibawah ini manakah yang termasuk tulang belakang…",
  ...
  {
    questions: "Fungsi tulang belakang adalah…",
  ...
  {
    questions: "Tulang tengkorak bagian kepala terdiri atas...",
    optionA: "10 Tulang",
    optionB: "12 Tulang",
    optionC: "14 Tulang",
    optionD: "16 Tulang",
  ...
  {
    questions: "Tulang yang berbentuk kubus atau tidak beraturan disebut tulang…",
    optionA: "Pipih",
    optionB: "Pendek",
    optionC: "Pipa",
  ...
  {
    questions: "Tulang yang bersifat lentur disebut tulang…",
    optionA: "Rawan",
  ...
  {
    questions: "Tulang rawan terdapat pada…",
  ...
  {
    questions: "Sel-sel tulang keras yang telah mati akan membentuk rongga bekas sel tulang  yang disebut..",
    optionA: "Kartilago",
    optionB: "Osteosit",
    optionC: "Kalsium",
    optionD: "Lakuna",
  ...
  {
    questions: "Tulang tak berbentuk terdapat pada...",
    optionA: "Wajah",
    optionB: "Kaki",
    optionC: "Tangan",
    optionD: "Telinga",
  ...
  {
    questions: "Proses pembentukan tulang disebut...",
    optionA: "Sinartrosis",
    optionB: "Osifikasi",
  ...
  {
    questions: "Ruas tulang punggung berjumlah...",
    optionA: "5 ruas",
    optionB: "4 ruas",
    optionC: "7 ruas",
    optionD: "12 ruas",
  ...
  {
    questions: "“Terdiri atas epifisis (bagian ujung tulang yang membesar seperti bongkol) dan diafisis (bagian tengah tulang di antara dua epifisis)” Pengertian dari tulang…",
  ...
  {
    questions: "Tulang rusuk terdiri dari...jenis tulang",
    optionA: "3",
    optionB: "4",
    optionC: "5",
    optionD: "6",
...
function handleEndGame() {
  ...
  if (playerScore <= 0) {
    ...
    remarkColor = "red";
  } else if (playerScore >= 1 && playerScore < 10) {
